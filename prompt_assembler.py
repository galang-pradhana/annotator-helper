...
ASSET_CONFIGS = {
    "PR": {
        ...
        "supplements": ["guidelines/supplements/PR_qna.md"],  # aktif saat file ditaruh
    ...
    "AFM": {
        ...
        "supplements": ["guidelines/supplements/AFM_qna.md"],
    ...
    "TC_MESSAGE_REPLY": {
        ...
        "supplements": ["guidelines/supplements/TC_MESSAGE_REPLY_qna.md"],
    ...
    "TC_PROOFREADING": {
        ...
        "supplements": ["guidelines/supplements/TC_PROOFREADING_qna.md"],
    ...
    "CYU": {
        ...
        "supplements": ["guidelines/supplements/CYU_qna.md"],
    ...
    "CYU_TOPLINE_SUMMARIZATION": {
        ...
        "supplements": ["guidelines/supplements/CYU_TOPLINE_SUMMARIZATION_qna.md"],
    ...
    "VCG_ADM_BASE_CREATION": {
        ...
        "supplements": ["guidelines/supplements/VCG_ADM_BASE_CREATION_qna.md"],
    ...
    "VCG_BACKGROUND_MESSAGE": {
        ...
        "supplements": ["guidelines/supplements/VCG_BACKGROUND_MESSAGE_qna.md"],
    ...
    "VCG_EDIT_MODEL": {
        ...
        "supplements": ["guidelines/supplements/VCG_EDIT_MODEL_qna.md"],
    ...
    "VCG_PROMPT_REWRITE": {
        ...
        "supplements": ["guidelines/supplements/VCG_PROMPT_REWRITE_qna.md"],
    ...
    "WRITING_TOOL_PROOFREAD_V2": {
        ...
        "supplements": ["guidelines/supplements/WRITING_TOOL_PROOFREAD_V2_qna.md"],
    ...
    "TA_PERSONALIZED_SMART_REPLY": {
        ...
        "supplements": ["guidelines/supplements/TA_PERSONALIZED_SMART_REPLY_qna.md"],
    ...
    "TA_WRITING_TOOLS_WRITING_QA": {
        ...
        "supplements": ["guidelines/supplements/TA_WRITING_TOOLS_WRITING_QA_qna.md"],
    ...
    "TA_WRITING_TOOLS_CONTEXTUAL_SYNONYMS": {
        ...
        "supplements": ["guidelines/supplements/TA_WRITING_TOOLS_CONTEXTUAL_SYNONYMS_qna.md"],
    ...
    "CYU_ACTION_ITEMS": {
        ...
        "supplements": ["guidelines/supplements/CYU_ACTION_ITEMS_qna.md"],
    ...
    "TA_INTELLIGENT_POLLS": {
        ...
        "supplements": ["guidelines/supplements/TA_INTELLIGENT_POLLS_qna.md"],
    ...
    "VCG_EDIT_MODEL_DIRECT_MANIPULATION": {
        ...
        "supplements": ["guidelines/supplements/VCG_EDIT_MODEL_DIRECT_MANIPULATION_qna.md"],
    ...
    "AFM_SAFETY_EVALUATION_AFM4": {
        ...
        "supplements": ["guidelines/supplements/AFM_SAFETY_EVALUATION_AFM4_qna.md"],
